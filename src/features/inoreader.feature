Feature: 
  ...
  Scenario Outline: Read Items in www.inoreader.com
    ...
    When I add "On3p1us3t" to the inputfield "#password"
    ...
    Examples: 
      | url                              | items |
      | [data-folderid='pinterest-c']    |   200 |
      | [data-folderid='pinterest']      |   200 |
      | [data-folderid='pinterest-ce']   |   200 |
      | [data-folderid='Pinterest-Cars'] |    50 |
